...
### Observe <a href="#observe" id="observe" />
...
remote_agent = agent_engines.create(
    ...
    env_vars={
        "PHOENIX_COLLECTOR_ENDPOINT": "https://app.phoenix.arize.com/s/<handle>/v1/traces",  # Or your self-hosted Phoenix URL
