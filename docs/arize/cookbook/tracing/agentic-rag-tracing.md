...
<Card title="Agent Rag Tracing" href="https://colab.research.google.com/github/arize-ai/phoenix/blob/main/tutorials/tracing/agentic_rag_tracing.ipynb" icon="route" description="Agentic RAG tracing notebook" />
