...
<Tabs>
  <Tab title="UI">
    <Frame caption="">
      <iframe src="https://storage.googleapis.com/arize-phoenix-assets/assets/images/added_broad_vs_specific_instruction.mp4" allowFullScreen style={{ width: '100%', height: '420px' }} allow="encrypted-media *;" className="aspect-video" />
    </Frame>
  </Tab>
...
<Tabs>
  <Tab title="UI">
    <Frame caption="Edit prompt parameters">
      <iframe src="https://storage.googleapis.com/arize-phoenix-assets/assets/images/prompt_params.mp4" allowFullScreen style={{ width: '100%', height: '420px' }} allow="encrypted-media *;" className="aspect-video" />
    </Frame>
  </Tab>
