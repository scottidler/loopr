...
<Frame caption="Create a New Dataset & add Examples">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/ts-first-dataset.mp4" />
</Frame>
...
<Frame caption="Save the Financial Research Agent Prompt">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/ts-first-prompt.mp4" />
</Frame>
...
<Frame caption="Run the Saved Prompt on your Dataset of Failed Traces">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/ts-playground-experiment.mp4" />
</Frame>
...
<Frame caption="Update Prompt & Run a Comparison in Prompt Playground">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/ts-compare-prompts.mp4" />
</Frame>
...
<Frame caption="View Prompt Playground Runs through Experiment View">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/ts-view-experiment.mp4" />
</Frame>
