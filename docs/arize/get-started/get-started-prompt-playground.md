...
<Frame caption="Create a New Dataset & add Examples">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/make%20dataset%20python%20quickstart.mp4" />
</Frame>
...
<Frame caption="Save the Financial Research Agent Prompt">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/save_a_prompt.mp4" />
</Frame>
...
<Frame caption="Run the Saved Prompt on your Dataset of Failed Traces">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/first%20prompt%20run.mp4" />
</Frame>
...
<Frame caption="Update Prompt & Run a Comparison in Prompt Playground">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/iterate%20on%20prompt.mp4" />
</Frame>
...
<Frame caption="View Prompt Playground Runs through Experiment View">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/prompt%20playground%20experiment%20view.mp4" />
</Frame>
