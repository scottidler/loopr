...
<Frame caption="Tracing Project with Evaluation Annotations">
  <video controls className="w-full aspect-video rounded-xl" src="https://storage.googleapis.com/arize-phoenix-assets/assets/videos/completeness%20evals%20quickstart.mp4" />
</Frame>
