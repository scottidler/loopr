...
> Phoenix supports loading data that contains [OpenInference traces](/docs/phoenix/references/openinference). This allows you to load an existing dataframe of traces into your Phoenix instance.
...
Before using the Phoenix client, be sure you've set the following environment variables:
