...
> Evaluate whether retrieved documents are relevant to user queries
...
<Note>
  In TypeScript, the field is named `documentText` (camelCase) instead of `document_text` (snake\_case).
</Note>
