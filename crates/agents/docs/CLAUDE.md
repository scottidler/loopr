...
Design documentation scoped to the `agents` crate.

## What lives here

- Design docs touching only `agents` (Ralph loops for Implementer, Reviewer, Researcher, Director; retry and escalation strategies; role-specific prompts).
...
- [../CLAUDE.md](../CLAUDE.md): scope rules for `agents`
