# crates/decomposer/docs/

Design documentation scoped to the `decomposer` crate.

## What lives here

- Design docs touching only `decomposer` (Plan production, Plan-to-Work-DAG, DecomposeStrategy impls, dependency resolution).
...
- [../CLAUDE.md](../CLAUDE.md): scope rules for `decomposer`
