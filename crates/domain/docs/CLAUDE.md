...
Design documentation scoped to the `domain` crate.

## What lives here

- Design docs touching only `domain` (records, FSMs, TaskStore wrapper).
...
- [../CLAUDE.md](../CLAUDE.md): scope rules for `domain`
