...
#[instrument(skip_all, fields(answer = ?req.params.get("answer")))]
...
#[instrument(skip_all, fields(question_count = req.params.get("questions").and_then(|v| v.as_array()).map(|a| a.len())))]
